...
BUILD_SLN=./jaytwo.HashSiphon.sln
BUILD_DIR=./src/jaytwo.HashSiphon
BUILD_TEST_DIR=./test/jaytwo.HashSiphon.Tests
BUILD_TRX_FILENAME=jaytwo.HashSiphon.Tests.trx
